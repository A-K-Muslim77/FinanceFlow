    ...
    <div className="min-h-screen relative">
      ...
      <div className="w-full mx-auto py-3 sm:py-6 relative z-10">
        <div className="space-y-3 sm:space-y-6 pb-16 sm:pb-20">
          ...
          {/* Summary Cards */}
          <div className="grid grid-cols-1 sm:grid-cols-5 gap-3 sm:gap-4 mx-2 sm:mx-4 lg:mx-6">
              ...
              <div className="p-4 sm:p-5">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-lg sm:text-xl font-bold text-purple-500 truncate">
                      {totals.totalPeople}
                    </p>
                  </div>
          ...
          {/* Search and Filter */}
          <div className="space-y-3 mx-2 sm:mx-4 lg:mx-6">
            {/* Search Bar */}
                        ...
                        <div className="flex items-center justify-between sm:justify-end gap-2 sm:gap-3">
                          ...
                          <div className="flex items-center gap-0.5 sm:gap-1">
                            <button
                              ...
                              className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 hover:bg-slate-100 h-7 w-7 sm:h-8 sm:w-8"
                              title="View Details"
                            >
